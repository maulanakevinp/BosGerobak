...
class CategoriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('categories')->insert([
            ...
            'deskripsi'     => 'PRAKTIS dan MUDAH DIPINDAHKAN, adalah 2 keunggulan yang bisa Anda dapatkan dari Gerobak Lipat. Gerobak jenis ini akan sangat sesuai untuk Anda yang memiliki lapak jualan berpindah-pindah.',
            'keunggulan'    => '<div class="container">
        ...
        DB::table('categories')->insert([
            ...
            'deskripsi'     => 'UNIK-MENARIK. Berikan sentuhan unik dan nyentrik pada outlet jualan Anda dengan gerobak yang sedang HIT saat ini! Lebih mahal dari gerobak lipat namun lebih murah dari Gerobak jenis Indoor.',
            'keunggulan'    => '<div class="container">
                                    <ul class="text-center text-white">
                                        <li>Lebih Kuat</li>
                                        <li>Lebih Menarik</li>
